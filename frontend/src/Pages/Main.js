  ...
  const handleFileUpload = async (event) => {
    ...
    if (file) {
      ...
      try {
        ...
        // const extractedAuthorName = metadata.info.Author || 'Unknown Author';
        setAuthorName(pdfData);
      } catch (error) {
        console.error('Error occurred while extracting author name:', error);
        setAuthorName('Error occurred');
      }
    }
  };
